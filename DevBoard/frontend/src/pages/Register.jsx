...
import { Briefcase, User, Mail, Lock, Shield, ArrowRight, AlertTriangle } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Registration failed. Please review fields.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Join DevBoard to manage agile sprints and task pipelines.
          </p>
        </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="block w-full rounded-xl border border-slate-800 bg-slate-950/60 py-3 pr-4 pl-10 text-sm text-white placeholder-slate-500 outline-none transition-all focus:border-brand-500 focus:ring-1 focus:ring-brand-500 appearance-none cursor-pointer"
                >
